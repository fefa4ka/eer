...
RELEASE(SimpleComponent) { state->value = props->value; }
...
result_t test_simple_component() {
  ...
  test_assert(component_mounted == true, "Component should be mounted");

  // Verify the value was updated
  test_assert(updated_value == 100, "Value should be updated to 100");
